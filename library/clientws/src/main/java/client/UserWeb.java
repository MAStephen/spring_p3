 ...
 * 
 */
@WebServiceClient(name = "userWeb", targetNamespace = "http://webService2.p3/", wsdlLocation = "http://localhost:8080/webservice/userWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWEB_QNAME = new QName("http://webService2.p3/", "userWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservice/userWs?wsdl");
    ...
    public UserWs getUserWsPort() {
        return super.getPort(new QName("http://webService2.p3/", "userWsPort"), UserWs.class);
    }
    ...
    public UserWs getUserWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService2.p3/", "userWsPort"), UserWs.class, features);
    }
